...
\autoref{fig:basiconly} shows the measure computation times of the basic color refinement algorithm for the three paths graphs of sizes 5 through 5120. The larger sizes of this graph took too long to compute within reasonable time.
